  ...
  <div class="col-lg-12">
    <section class="panel">
      ...
      <div class="panel-body">
        <form class="form-horizontal form-bordered" action="<?php echo base_url("kullanicilar/update/$item->id"); ?>" method="post" method="post">
	   ...
	   <div class="form-group">
        ...
        <div class="col-md-10">
          <select name="type" id="user_type">
			  ...
			  <option <?=$item->type=='pharmacist'?'selected="selected"':'';?> value="pharmacist">Pharmacist</option>
		  </select>
        </div>
        </div>
